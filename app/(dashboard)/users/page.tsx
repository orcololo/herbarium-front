        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-[#DDDDDD]">
              <th className="px-6 py-3 text-left text-xs font-semibold text-[#9E9E9E] uppercase tracking-wider">Name</th>
              <th className="px-6 py-3 text-left text-xs font-semibold text-[#9E9E9E] uppercase tracking-wider">Email</th>
              <th className="px-6 py-3 text-left text-xs font-semibold text-[#9E9E9E] uppercase tracking-wider">Role</th>
              <th className="px-6 py-3 text-left text-xs font-semibold text-[#9E9E9E] uppercase tracking-wider">Institution</th>
              <th className="px-6 py-3 text-left text-xs font-semibold text-[#9E9E9E] uppercase tracking-wider">Joined</th>
            </tr>
          </thead>
