...
export default function SpeciesDetailPage() {
  ...
  if (error || !item) {
    return (
      <div className="max-w-4xl mx-auto animate-fade-in">
        <Link
          href="/species"
          className="inline-flex items-center gap-2 text-sm font-medium text-[#6D4C41] hover:text-[#1C1B1F] mb-6 transition-colors"
        >
        ...
        <div className="bg-[#FFEBEE] text-[#C62828] px-6 py-5 rounded-[20px] border border-[#FFCDD2] flex items-center gap-4">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path
              d="M12 8V12M12 16H12.01M3 12C3 7.029 7.029 3 12 3s9 4.029 9 9-4.029 9-9 9-9-4.029-9-9Z"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
            />
  ...
  return (
    <div className="max-w-4xl mx-auto animate-fade-in pb-12">
      ...
      {saveError && (
        <div className="bg-[#FFEBEE] text-[#C62828] px-4 py-3 rounded-xl mb-6 text-sm border border-[#FFCDD2] flex items-center gap-3">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path
      ...
      <header className="flex items-start justify-between gap-4 mb-8">
        <div className="flex items-center gap-5">
          <div className="w-16 h-16 rounded-full bg-[#3D7A52] flex items-center justify-center shrink-0 shadow-sm">
            <span className="text-white font-mono font-bold text-2xl">
              {item.scientificName.charAt(0).toUpperCase()}
            </span>
          </div>
          <div>
            <h1 className="text-2xl font-bold italic text-[#1C1B1F] tracking-tight">
              {item.scientificName}
            </h1>
            {item.commonName && (
              <p className="text-sm text-[#6D4C41] mt-1">{item.commonName}</p>
            )}
            {item.category && (
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                <path
                  d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.5l13.732-13.732z"
                  stroke="currentColor"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-[#F5F5F5] text-sm text-[#1C1B1F] border-2 border-transparent focus:border-[#3D7A52] outline-none transition-colors italic"
                />
              </div>
              <div>
                <label className="block text-[10px] font-bold text-[#9E9E9E] uppercase tracking-wider mb-1">
