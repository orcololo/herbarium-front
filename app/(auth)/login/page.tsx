    ...
    <div className="w-full max-w-md animate-slide-up">
      <div className="bg-white/95 backdrop-blur-xl rounded-[24px] shadow-[0_8px_32px_rgba(0,0,0,0.2)] overflow-hidden border border-white/20">
        <div className="px-8 pt-12 pb-6 text-center flex flex-col items-center">
          <div className="inline-flex items-center justify-center w-[72px] h-[72px] rounded-full bg-[#E8F5E9] mb-6 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="px-8 pb-10 space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3.5 rounded-[12px] bg-[#F5F5F5] text-[#1C1B1F] text-sm outline-none border-2 border-transparent focus:border-[#3D7A52] transition-all duration-200 placeholder:text-[#AAAAAA]"
