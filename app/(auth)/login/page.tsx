        ...
        <form onSubmit={handleSubmit} className="px-8 pb-10 space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3.5 rounded-xl bg-[#F5F5F5] text-[#1C1B1F] text-sm outline-none border-2 border-transparent focus:border-[#3D7A52] transition-all duration-200 placeholder:text-[#AAAAAA]"
